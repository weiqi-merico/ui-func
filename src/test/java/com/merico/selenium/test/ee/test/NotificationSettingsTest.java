...
public class NotificationSettingsTest extends TestBase {
protected Logger logger = LoggerFactory.getLogger(getClass());
	...
	public void testAddNotificationGroup() throws Exception {
		SettingsPage settingsPage = PageFactory.createPage(SettingsPage.class, driver);
		settingsPage.navigateToSettings();
		settingsPage.addNotificationGroup4Personnel();
