...
public class GroupMetricsTrendsTest extends TestBase {
protected Logger logger = LoggerFactory.getLogger(getClass());
	...
	public void testRepoDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
	...
	public void testSlocDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.slocLineChartDisplay4GroupMetricsTrends();
		...
		repoReportPage.slocBarChartDisplay4GroupMetricsTrends();
	...
	public void testNumOfCommitsDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.numOfCommitsLineChartDisplay4GroupMetricsTrends();
		...
		repoReportPage.numOfCommitsBarChartDisplay4GroupMetricsTrends();
	...
	public void testGuidesTooltipDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.guidesQuestionMark4GroupMetricsTrends();
	...
	public void testLastWeekDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.lastWeekDisplay4GroupMetricsTrends();
	...
	public void testLastMonthWithDayDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.lastMonthDisplayByDay4GroupMetricsTrends();
	...
	public void testLastMonthWithWeekDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.lastMonthDisplayByWeek4GroupMetricsTrends();
	...
	public void testLastYearWithDayDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.lastYearDisplayByDay4GroupMetricsTrends();
	...
	public void testLastYearWithWeekDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.lastYearDisplayByWeek4GroupMetricsTrends();
	...
	public void testLastYearWithMonthDisplay() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.lastYearDisplayByMonth4GroupMetricsTrends();
