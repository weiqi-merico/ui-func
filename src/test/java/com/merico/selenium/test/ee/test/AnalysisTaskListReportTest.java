...
protected Logger logger = LoggerFactory.getLogger(getClass());
	...
	public void testBackwardAnalysis(String repoUrl) throws Exception {
		...
		repoReportPage.backwardAnalysis();
		
		Assert.assertEquals(repoReportPage.getAbnomalAnalysisInfo(), "Analysis cancelled.", "Backward Analysis Failed!");
	}
	
	@Test(groups = {CasePriority.BVT}, dependsOnMethods = {"testBackwardAnalysis"}, alwaysRun = true)
	public void testPagination() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.paginationJumper4AnalysisTaskListTable();
		
		Assert.assertEquals(repoReportPage.getPaginationFocus4AnalysisTaskList(), "rgba(202, 69, 33, 1)", "Pagination Jumper for Analysis Task List Page Failed!");
	}
	...
	public void testFixedPagination() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.fixedPagination4AnalysisTaskListTable();
