...
public class CodeDuplicatesTest extends TestBase {
protected Logger logger = LoggerFactory.getLogger(getClass());
	...
	public void testBranchHashCopy(String repoUrl) throws Exception {
		...
		repoReportPage.branchHashCopy4CodeDuplicates();
		
		Assert.assertEquals(repoReportPage.getBranchHashCopyTooltip4CodeDuplicates(), "复制成功", "Branch Hash Copy for Code Duplicates Failed!");
	}
	...
	public void testSelectBranch() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.selectBranch4CodeProblems();
		
		Assert.assertTrue(repoReportPage.getGroup4CodeDuplicates().contains("组"), "Select Branch for Code Duplicates Failed!");
		Assert.assertTrue(repoReportPage.getFile4CodeDuplicates(), "Select Branch Group for Code Duplicates Failed!");
		Assert.assertTrue(repoReportPage.getSource4CodeDuplicates(), "Select Branch Source for Code Duplicates Failed!");
	}
	...
	public void testFixedPagination() throws Exception {
		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
		repoReportPage.fixedPagination4CodeDuplicates();
