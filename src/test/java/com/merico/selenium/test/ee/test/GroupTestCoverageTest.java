...
public class GroupTestCoverageTest extends TestBase {
protected Logger logger = LoggerFactory.getLogger(getClass());
	...
	public void testIntoOverallReport() throws Exception {
		...
		repoReportPage.enterIntoTestCoverage4GroupTestCoverage();
	}
...
//		RepoReportPage repoReportPage = PageFactory.createPage(RepoReportPage.class, driver);
//		repoReportPage.uncoveredFunctionsLoadMore4GroupTestCoverage();
//		
